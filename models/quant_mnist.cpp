...
}
{
    ...
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/Layer1_MatMul_eightbit_reshape_dims_0.idx"),
            "Layer1/MatMul_eightbit_reshape_dims:0",
            1);
}
{
    ctx.add(new RamTensor<float>(), "Layer1/MatMul_eightbit_reshape_x:0", 2);
    ctx.push(new ReshapeOp(), 
             { "x:0", "Layer1/MatMul_eightbit_reshape_dims:0" },
             { "Layer1/MatMul_eightbit_reshape_x:0" });
    ctx.eval();
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/Layer1_MatMul_eightbit_reduction_dims_0.idx"),
...
{   
    ...
    ctx.add(out_tensor, "Layer1/MatMul_eightbit_min_x:0", 1);
    ctx.push(new MinOp(), 
             { "Layer1/MatMul_eightbit_reshape_x:0", "Layer1/MatMul_eightbit_reduction_dims:0" },
             { "Layer1/MatMul_eightbit_min_x:0" });
    ctx.eval();
}
{   
    RamTensor<float>* out_tensor;
    out_tensor = new RamTensor<float>({ 1 });
    ctx.add(out_tensor, "Layer1/MatMul_eightbit_max_x:0", 1);
    ctx.push(new MaxOp(), 
             { "Layer1/MatMul_eightbit_reshape_x:0", "Layer1/MatMul_eightbit_reduction_dims:0" },
             { "Layer1/MatMul_eightbit_max_x:0" });
    ctx.eval();
}
{
    ctx.add(new RamTensor<uint8_t>(), "Layer1/MatMul_eightbit_quantize_x:0", 1);
    ctx.add(new RamTensor<float>({1}), "Layer1/MatMul_eightbit_quantize_x:1", 1);
    ctx.add(new RamTensor<float>({1}), "Layer1/MatMul_eightbit_quantize_x:2", 1);
    ctx.push(new QuantizeV2Op(),
             {  "x:0",  "Layer1/MatMul_eightbit_min_x:0", "Layer1/MatMul_eightbit_max_x:0" },
             {  "Layer1/MatMul_eightbit_quantize_x:0",  "Layer1/MatMul_eightbit_quantize_x:1", "Layer1/MatMul_eightbit_quantize_x:2" });
    ctx.eval();
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.ubyte_import("/fs/constants/quant_mnist/Layer1_Variable_quint8_const_0.idx"),
            "Layer1/Variable_quint8_const:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/Layer1_Variable_min_0.idx"),
            "Layer1/Variable_min:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/Layer1_Variable_max_0.idx"),
...
}
{
    ...
    ctx.push(new QntMatMulOp<uint8_t, uint8_t, int>(), 
             { "Layer1/MatMul_eightbit_quantize_x:0", "Layer1/MatMul_eightbit_quantize_x:1", "Layer1/MatMul_eightbit_quantize_x:2", "Layer1/Variable_quint8_const:0", "Layer1/Variable_min:0",  "Layer1/Variable_max:0" },
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/Layer1_Variable_1_0.idx"),
            "Layer1/Variable_1:0",
            1);
}
{
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/Layer1_Relu_eightbit_reshape_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/Layer1_Relu_eightbit_reduction_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/Layer2_Variable_min_0.idx"),
            "Layer2/Variable_min:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/Layer2_Variable_max_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/Layer2_Variable_1_0.idx"),
            "Layer2/Variable_1:0",
            1);
}
{
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/Layer2_Relu_eightbit_reshape_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/Layer2_Relu_eightbit_reduction_dims_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/OuputLayer_Variable_min_0.idx"),
            "OuputLayer/Variable_min:0",
            1);
}
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/OuputLayer_Variable_max_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.float_import("/fs/constants/quant_mnist/OuputLayer_Variable_1_0.idx"),
...
{
    TensorIdxImporter t_import;
    ctx.add(t_import.int_import("/fs/constants/quant_mnist/y_pred_dimension_0.idx"),
            "y_pred/dimension:0",
            1);
}
{
    ...
    ctx.push(new ArgMaxOp<float, int>(), 
             { "OuputLayer/logits:0", "y_pred/dimension:0" },
             { "y_pred:0" });
}
}